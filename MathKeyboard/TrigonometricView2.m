...
@implementation TrigonometricView2
...
- (id)initWithFrame:(CGRect)viewFrame andDelegate:(id)delg withOptionString:(NSString*)option andColor:(UIColor*)color
{
    ...
    if(self)
    {
        ...
        [[NSBundle mainBundle] loadNibNamed:@"TrigonometricView2" owner:self options:nil];
        ...
        self.txt = [[UITextField alloc]initWithFrame:CGRectMake(self.lbl.frame.origin.x+self.lbl.frame.size.width+2, 0, 25, self.view.frame.size.height/2)];
